...
(async()=>{
  ...
  click('[data-a=meals]');inp(d.getElementById('mlname'),'Frühstück');click('[data-x=save]');click('[data-x=book]');check('Mahlzeit gebucht',store().macros[Object.keys(store().macros)[0]].length===2);
